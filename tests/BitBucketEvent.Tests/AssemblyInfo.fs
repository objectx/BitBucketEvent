...
[<assembly: AssemblyTitleAttribute("BitBucketEvent.Tests")>]
[<assembly: AssemblyProductAttribute("BitBucketEvent")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "BitBucketEvent.Tests"
    let [<Literal>] AssemblyProduct = "BitBucketEvent"
